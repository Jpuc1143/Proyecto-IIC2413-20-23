...
\copy persona from './data_impar/persona.csv' DELIMITER ',' CSV HEADER;
\copy compania_aerea from './data_impar/compania_aerea.csv' DELIMITER ',' CSV HEADER;
\copy empleado_en from './data_impar/empleado_en.csv' DELIMITER ',' CSV HEADER;

\copy tripulacion_en from './data_impar/tripulacion_en.csv' DELIMITER ',' CSV HEADER;
\copy piloto_en from './data_impar/piloto_en.csv' DELIMITER ',' CSV HEADER;
\copy copiloto_en from './data_impar/copiloto_en.csv' DELIMITER ',' CSV HEADER;
\copy licencia_piloto from './data_impar/licencia_piloto.csv' DELIMITER ',' CSV HEADER;

\copy cliente from './data_impar/cliente.csv' DELIMITER ',' CSV HEADER;
\copy reserva from './data_impar/reserva.csv' DELIMITER ',' CSV HEADER;
\copy ticket from './data_impar/ticket.csv' DELIMITER ',' CSV HEADER;

\copy vuelo from './data_impar/vuelo.csv' DELIMITER ',' CSV HEADER;
\copy aerodromo from './data_impar/aerodromo.csv' DELIMITER ',' CSV HEADER;
\copy ciudad from './data_impar/ciudad.csv' DELIMITER ',' CSV HEADER;
\copy ruta from './data_impar/ruta.csv' DELIMITER ',' CSV HEADER;
\copy punto from './data_impar/punto.csv' DELIMITER ',' CSV HEADER;
\copy aeronave from './data_impar/aeronave.csv' DELIMITER ',' CSV HEADER;
\copy costo from './data_impar/costo.csv' DELIMITER ',' CSV HEADER;
