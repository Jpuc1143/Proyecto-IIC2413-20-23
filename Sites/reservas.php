...
<form action="verificar.php" method="post" target="_blanck">
    ...
    <?php 
        foreach($data as $d => $reserva){
            ?>
            <option value="<?php echo $reserva[0]; ?>">
    ...
    <tr>
    <td><input type="text" name="pasaporte_1" placeholder="Código de Pasaporte">
        <input type="text" name="pasaporte_2" placeholder="Código de Pasaporte">
        <input type="text" name="pasaporte_3" placeholder="Código de Pasaporte">
	<input type="hidden" name="reservador" value=<?php echo $_POST["reservador"] ?>>
    </tr>
    </table>
